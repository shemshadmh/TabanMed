...
namespace Persistence.Migrations
{
    ...
    [Migration("20220827145923_TabanMed_20220827_192734")]
    partial class TabanMed_20220827_192734
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Identity.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "b3b7b99a-6b65-4e41-919e-61bbfb5744a3",
                            Created = new DateTime(2022, 8, 27, 14, 59, 19, 546, DateTimeKind.Utc).AddTicks(4514),
                            CreatedBy = "Seed",
                            ...
                            SecurityStamp = "fa8aabe9-1546-46cd-bd3c-a842316b308a",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = (byte)0,
                            ConcurrencyStamp = "a7266488-0735-4be7-ae3a-4ccd829f20e0",
                            Created = new DateTime(2022, 8, 27, 14, 59, 19, 546, DateTimeKind.Utc).AddTicks(4609),
                            CreatedBy = "Seed",
                            ...
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "3ed01310-0c04-4a12-9beb-891f0ebe297d",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("Domain.Entities.Identity.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "de63f70e-4919-4895-9036-34a99d8ad2a9",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "f3c5a061-bcdf-4e7c-a58a-65780dbda806",
            ...
            modelBuilder.Entity("Domain.Entities.MedicalCenters.MedicalCenterMedicalService", b =>
                {
                    ...
                    b.HasKey("MedicalCenterId", "MedicalServiceId");

                    b.HasIndex("MedicalServiceId");

                    b.ToTable("MedicalCenterMedicalServices");
                });

            modelBuilder.Entity("Domain.Entities.MedicalCenters.MedicalService", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.MedicalCenters.Translation.MedicalServiceTranslation", b =>
                {
                    b.Property<int>("MedicalServiceId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("MedicalServiceId", "LanguageId");

                    b.HasIndex("LanguageId");

                    b.ToTable("MedicalServiceTranslations");
                });
            ...
            modelBuilder.Entity("Domain.Entities.TourServices.TourService", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.TourServices.Translation.TourServiceTranslation", b =>
                {
                    b.Property<int>("TourServiceId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("TourServiceId", "LanguageId");

                    b.HasIndex("LanguageId");

                    b.ToTable("TourServiceTranslations");
                });
            ...
            modelBuilder.Entity("Domain.Entities.MedicalCenters.MedicalCenterMedicalService", b =>
                {
                    b.HasOne("Domain.Entities.MedicalCenters.MedicalCenter", "MedicalCenter")
                        .WithMany("MedicalCenterMedicalServices")
                        .HasForeignKey("MedicalCenterId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Domain.Entities.MedicalCenters.MedicalService", "MedicalService")
                        .WithMany("MedicalCenterMedicalServices")
            ...
            modelBuilder.Entity("Domain.Entities.MedicalCenters.MedicalService", b =>
                {
                    b.HasOne("Domain.Entities.MedicalCenters.MedicalService", "Parent")
                        .WithMany("Children")
                        .HasForeignKey("ParentId")
                        .OnDelete(DeleteBehavior.NoAction);
            ...
            modelBuilder.Entity("Domain.Entities.MedicalCenters.Translation.MedicalServiceTranslation", b =>
                {
                    b.HasOne("Domain.Entities.Localization.Language", "Language")
                        .WithMany("MedicalServiceTranslations")
                        .HasForeignKey("LanguageId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.TourServices.Translation.TourServiceTranslation", b =>
                {
                    b.HasOne("Domain.Entities.Localization.Language", "Language")
                        .WithMany("TourServiceTranslations")
                        .HasForeignKey("LanguageId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Domain.Entities.TourServices.TourService", "TourService")
                        .WithMany("TourServiceTranslation")
                        .HasForeignKey("TourServiceId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.Localization.Language", b =>
                {
                    ...
                    b.Navigation("MedicalServiceTranslations");

                    b.Navigation("TourServiceTranslations");
                });

            modelBuilder.Entity("Domain.Entities.MedicalCenters.MedicalCenter", b =>
                {
                    b.Navigation("MedicalCenterMedicalServices");
            ...
            modelBuilder.Entity("Domain.Entities.TourServices.TourService", b =>
                {
                    b.Navigation("TourServiceTranslation");
                });
